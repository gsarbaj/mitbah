            ...
            <div className={'flex justify-center space-x-4 mt-6'}>
                                    ...
                                    <FormField
                                        ...
                                        render={({field}) => (
                                            <FormItem>
                                                ...
                                                <FormControl>
                                                    <Input className={'w-80'} inputMode={'tel'}
                                                           placeholder="Telefono numeris" {...field} autoFocus/>
                                                </FormControl>
                                                <FormMessage/>
                                            </FormItem>
                                        )}
                                    ...
                                    <FormField
                                        ...
                                        render={({field}) => (
                                            <FormItem>
                                                ...
                                                <FormControl>
                                                    <Input
                                                        className={'w-80 focus:ring-2 focus:ring-blue-500 focus:outline-none'}
                                                        inputMode={'text'}
                                                        placeholder="Vardenis Pavardenis" {...field} />
                                                </FormControl>
                                    ...
                                    <FormField
                                        ...
                                        render={({field}) => (
                                            <FormItem>
                                                ...
                                                <FormControl>
                                                    <Input className={'w-80'} inputMode={'text'}
                                                           placeholder="Draugystės g. 27-53" {...field} autoFocus/>
                                                </FormControl>
                                                <FormMessage/>
                                            </FormItem>
                                        )}
                                        ...
                                        render={({field}) => (
                                            <FormItem>
                                                ...
                                                <FormControl>
                                                    <Input
                                                        className={'w-80 focus:ring-2 focus:ring-blue-500 focus:outline-none'}
                                                        inputMode={'text'} placeholder="Vilnius" {...field} />
                                                </FormControl>
                                                <FormMessage/>
                                            </FormItem>
                                        )}
                ...
                <div className={`${thirdFormDivClassName}`}>
                    <Form {...form}>
                        <form onSubmit={form.handleSubmit(thirdFormSubmit)} className="space-y-8">
                            ...
                            />
                            <Button
                                type="submit">{form.getValues("visit_date") ? `Iškviesti ${format(form.getValues("visit_date") || new Date(), "EEEE, MMMM do", {locale: lt})}` :
                                <p>Pasirinkti datą</p>}</Button>
                        </form>
                    </Form>
                </div>
                ...
                <div className={finalBlock}>
                    <div className={' flex flex-col justify-center'}>
                        <h3 className={'font-bold m-4'}>Užpildykite formą 2</h3>
                        <div>
                            {form.getValues("visit_date") ? ` Apsilankymas užsakytas ${format(form.getValues("visit_date") || new Date(), "EEEE, MMMM do", {locale: lt})}. ` :
                                <p>Pasirinkti datą</p>}
                    ...
                    <div className={'flex ml-4 mt-1'}>
                        <div className={''}>
                            <div className={firstStepClassName}>
                                <div className={'relative text-center top-1/2 -translate-y-1/2'}><p
                                    className={'text-primary-foreground'}>{firstSign}</p></div>
                            </div>
                    ...
                    <div className={'flex ml-4 mt-1'}>
                        <div className={''}>
                            <div className={secondStepClassName}>
                                <div className={'relative text-center top-1/2 -translate-y-1/2'}><p
                                    className={'text-primary-foreground'}>{secondSign}</p></div>
                            </div>
                            <div className={'flex justify-center'}>
                    ...
                    <div className={'flex ml-4 mt-1'}>
                        <div className={''}>
                            <div className={thirdStepClassName}>
                                <div className={'relative text-center top-1/2 -translate-y-1/2'}><p
                                    className={'text-primary-foreground'}>{thirdSign}</p></div>
                            </div>
                            <div className={'flex justify-center'}>
